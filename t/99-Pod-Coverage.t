...
pod_coverage_ok('PerlT::LP5::Ch07');
pod_coverage_ok('PerlT::LP5::Ch08');
pod_coverage_ok('PerlT::LP5::Ch09');
pod_coverage_ok('PerlT::LP5::Ch10');
pod_coverage_ok('PerlT::LP5::Ch11');
